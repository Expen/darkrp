...
local my_language = {
	...
	need_money = "NBesoin de %s",

	payday_message = "Salaire ! Vous avez reçu  %s!",
	payday_unemployed = "Vous êtes au chômage, vous ne recevez aucun salaire.",
	payday_missed = "Vous êtes arrêté, vous ne recevez aucun salaire.",

	property_tax = "Taxe de propriété de %s",
	property_tax_cant_afford = "You couldn't pay the taxes! Your property has been taken away from you!",
	taxday = "Jour de taxe, %s%% vient d'être débité de votre compte",
	...
	wanted = "Recherché par les forces de l'ordre !\nReason: %s",
	youre_arrested = "Vous été arrêté pour %d secondes!",
	...
	hes_unarrested = "%s a été libéré de prison après avoir purgé sa peine!",
	warrant_ordered = "%s ordonne un avis de recherhce sur  %s. Raison: %s",
	warrant_request = "%s demande un avis de rechercher sur %s\nReason: %s",
